...
Our mitigation map offers cities a clear strategy against climate change. It designates individual parcels for "preservation" of natural greenspaces and wetlands, suggests "mitigation" by enhancing low-value properties with expansive nature-based solutions, and recommends "retrofitting" to integrate green infrastructure, such as green roofs and swales, into existing setups.

[mitigation map with and without risk] ZOOMABLE
