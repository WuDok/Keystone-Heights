...
import KH from './keystone.jpg'

export const metadata = {
  title: 'Keystone Heights - GIFT',
  description: 'Green Infrastructure For Towns',
}

<MDXImage src={KH} alt="Keystone Heights" width={800} />

# Introduction to GIFT

In the face of escalating climate challenges, understanding the specific risks posed to urban environments is paramount. GIFT (Green Infrastructure for Towns) maps the impacts of climate risk at the granular level of individual parcels across cities. Our focus for this analysis is on Keystone Heights.
...
We are excited to work together to protect Keystone Heights from climate change and ensure a sustainable future for its residents.
...
As the urgency to address climate change intensifies, several organizations have emerged at the forefront, offering insights and solutions to manage and mitigate climate risks. The climate risks for Keystone Heights provided by each of the leading organizations follows.

- [FEMA National Risk Index](https://hazards.fema.gov/nri/map)
- [U.S. Climate Vulnerability Index](https://map.climatevulnerabilityindex.org/)
- [First Street Foundation’s Risk Factor](https://riskfactor.com/)
- [Climate Check](https://climatecheck.com/)

|                       | FEMA                | Climate Vulnerability Index        | Risk Factor    | Climate Check  |
| --------------------- | ------------------- | ---------------------------------- | -------------- | -------------- |
| National Climate Risk | 71st percentile     | 45th percentile                    | No Rating      | 1 to 96 Range  |
| Heat Risk             | No Rating           | Highest Vulnerability              | Severe         | Extreme        |
| Fire Risk             | Relatively High     | Highest Vulnerability              | Major          | Significant    |
| Storm Risk            | Relatively Moderate | Highest Vulnerability (Hurricanes) | Extreme (Wind) | Very High      |
| Flood Risk            | Relatively Moderate | Lower Vulnerability                | Minor          | Relatively Low |
| Drought Risk          | No Rating           | Lower Vulnerability                | No Rating      | Relatively Low |
