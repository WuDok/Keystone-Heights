...
## Notes: Should all sections have data source, fields used, method for calculations and mapping/legend? Find/Make Alert box component. For notes like this and special things to pay attention to in final doc.
